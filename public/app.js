...
$(document).ready(function () {
    ...
    var gramToLb = function gramToLb(quantity) {
        return quantity / 453.592;
    };
    var gramToKg = function gramToKg(quantity) {
        return quantity / 1000;
    };
    var gramToTn = function gramToTn(quantity) {
        return quantity / 1000000;
    };

    var lbToGram = function lbToGram(quantity) {
        return quantity * 453.592;
    };
    var lbToKg = function lbToKg(quantity) {
        return quantity * 0.453592;
    };
    var lbToTn = function lbToTn(quantity) {
        return quantity * 0.000453592;
    };

    var kgToGram = function kgToGram(quantity) {
        return quantity * 1000;
    };
    var kgToLb = function kgToLb(quantity) {
        return quantity * 2.20462;
    };
    var kgToTn = function kgToTn(quantity) {
        return quantity * 0.001;
    };

    var tnToGram = function tnToGram(quantity) {
        return quantity * 1000000;
    };
    var tnToLb = function tnToLb(quantity) {
        return quantity * 2204.62;
    };
    var tnToKg = function tnToKg(quantity) {
        return quantity * 1000;
    };
});
